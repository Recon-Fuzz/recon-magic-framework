---
description: "Phase 3A of the Efficient Properties Workflow v3.6. Fixes Setup.sol wiring (Step -1), ghost infrastructure (Step 0), and implements PROFIT + SIMPLE + CANARY properties. Runs forge build to verify compilation before Phase 3B."
mode: subagent
temperature: 0.1
---
